// =====================================================================
//   SMART PLANT CARE ROBOT  -  v6.3 (MEGA + 3-ZONE + PI SUPERVISOR)
...
//   v6.3: BA..BB — capacitive sensor migration, dup-define fix. (current)
// =====================================================================
...
void setup() {
  ...
  lcd.setCursor(0, 1); lcd.print(F("v6.3 Mega 3-zone"));
  delay(2000);
  lcd.clear();
  ...
  Serial.println(F("System started (v6.3 - Mega, 3 zones, Pi link)."));
}
