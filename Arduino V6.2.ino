// =====================================================================
//   SMART PLANT CARE ROBOT  -  v6.1 (MEGA + 3-ZONE + PI SUPERVISOR)
...
// Calibration: ADC value when sensor is in DRY soil (in air ~850)
// and WET soil (submerged ~350). Adjust after measuring your sensors.
const int MOISTURE_DRY_ADC  = 850;
const int MOISTURE_WET_ADC  = 350;
...
void setup() {
  ...
  lcd.setCursor(0, 1); lcd.print(F("v5.4 Mega 3-zone"));
  delay(2000);
  lcd.clear();
  ...
  Serial.println(F("System started (v5.4 - Mega, 3 zones, Pi link)."));
}
